// if the alarm is greater than zero, then it has been set off
if (alarm[1] >= 0)
{
    target_x = x + kb_x;
    target_y = y + kb_y;
...
// get instance count, if instance count is lower than max enemy number create an instance (using instance_create_layer)
enemy_number = instance_number(Obj_enemy1);
if enemy_number == enemy_number - 1 and can_check == true
{
    alarm[3] = 180;
    can_check = false;
}